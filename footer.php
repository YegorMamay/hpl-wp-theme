...
<footer class="page-footer">
    <p style="color:#333333">
        <?php _e('Developed by', 'brainworks') ?> <a style="color:#333333" href="https://brainworks.pro/" target="_blank" class="text-underline">BRAIN WORKS</a> &copy; 2017 - <?php echo date('Y'); ?>
    </p>
</footer>
</div>
<?php scroll_top(); ?>
